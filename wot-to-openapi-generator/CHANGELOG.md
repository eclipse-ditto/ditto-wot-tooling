...
No changes to this module. The repository is released under a single shared version, so
`1.2.1`, `1.2.2` and `1.2.3` were published for this artifact as well; all three contain
only fixes to the WoT Kotlin Generator Maven plugin.
