...
import org.eclipse.ditto.wot.kotlin.generator.common.serialize.ExplicitNullAwareSerializer
...
import org.eclipse.ditto.wot.kotlin.generator.plugin.dsl.DslGenerator
...
import org.eclipse.ditto.wot.kotlin.generator.plugin.util.Const.FEATURES_CLASS_NAME
...
object ClassGenerator {
    ...
    private suspend fun resolveExtendingLinkProperties(
        ...
        return links.filter { LinkRelationType.isExtends(it) }.map {
            val linkThingModel = ThingModelGenerator.loadModel(it.href.toString())
            val linkProperties = propertyResolver.resolveProperties(
