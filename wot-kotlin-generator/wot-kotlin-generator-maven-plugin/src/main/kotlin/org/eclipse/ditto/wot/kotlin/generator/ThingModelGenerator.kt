...
import org.eclipse.ditto.wot.kotlin.generator.loader.DittoBasedWotLoader
...
object ThingModelGenerator {
    ...
    suspend fun generate(thingModel: ThingModel, config: GeneratorConfiguration) {
        ...
        org.eclipse.ditto.wot.kotlin.generator.property.WrapperTypeChecker.setEnumGenerationStrategy(enumStrategy)
